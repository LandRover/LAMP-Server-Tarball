...
--enable-info \
--enable-mime-magic \
--enable-mods-shared='authn_core authn_file authz_core authz_host auth_basic suexec headers proxy status info mime deflate rewrite dir slotmem_shm ssl unique_id filter request expires log_config' \
